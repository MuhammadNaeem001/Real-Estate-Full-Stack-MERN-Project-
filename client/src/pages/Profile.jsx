...
export default function Profile() {
  ...
  const handleShowListings = async () => {
    try {
      ...
      console.log('insdile show', currentUser._id)
      console.log('insdile show', `/api/user/listings/${currentUser._id}`)
  ...
  return (
    <div className="max-w-lg p-3 mx-auto item-center">
      <h1
    ...
    my-7"
      ...
      onChange={handleChange}
        ...
        />
        <button
           disabled={loading}className="bg-slate-700 text-white rounded-lg
      ...
      <p className="text-green-700 mt-5">{updateUserSuccess ? 'user updated succeccfuly': ''}</p>

      <button onClick={handleShowListings} className="text-green-700 w-full">Show Listing</button>
      <p className="text-red-700 mt-5">
        {showListingsError ? 'Error showing listing':''}</p>
